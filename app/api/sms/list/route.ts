...
const ALIGO_API_KEY = process.env.NEXT_PUBLIC_ALIGO_API_KEY;
const ALIGO_USER_ID = process.env.NEXT_PUBLIC_ALIGO_USER_ID;
...
export async function POST(request: Request) {
  try {
    ...
    console.log('SMS List API Request Params:', apiParams);
    ...
    console.log('SMS List API Response:', response.data);
